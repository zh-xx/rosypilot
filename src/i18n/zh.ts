export const zh: Record<string, string> = {
	...
	'legal.slashCommand.hallucinationLabel': '幻觉校验',
	...
	'legal.panel.hallucination.detecting': '正在校验法律引用…',
	'legal.panel.hallucination.empty': '未发现法律引用',
	'legal.panel.hallucination.noApiKey': '请先在设置中填写元典 API Key',
	...
	'legal.panel.hallucination.locate.notFound': '未在正文中找到对应文字',
